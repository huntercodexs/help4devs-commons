...
@Slf4j
@Service
public abstract class Help4DevsEasyPdfTemplateBuilder extends Help4DevsEasyPdf {
    ...
    protected static void tableHeaderContentBuild(
            int box,
            int column,
            EasyPdfTemplateSettings easyPdfTemplateSettings,
            PDPageContentStream contentStream
    ) {
        try {

            SlimTemplateSettings settings = easyPdfTemplateSettings.getSlim();
            EasyPdfPage pageSettings = easyPdfTemplateSettings.getPage();
