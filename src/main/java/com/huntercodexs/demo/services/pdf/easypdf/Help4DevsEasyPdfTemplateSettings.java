...
import static com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfElements.*;

public class Help4DevsEasyPdfTemplateSettings {

    @Getter
    public enum EasyPdfTemplates {
        SLIM("SLIM"),
        BOX("BOX"),
        BOX_OPEN("BOX_OPEN"),
        SLIM_BOX("SLIM_BOX"),
        ...
        EasyPdfTemplates(String template) {
            this.template = template;
        }

        public static String template(EasyPdfTemplates template) {
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    public static class EasyPdfTemplateSettings {
        /*Template Name*/
        EasyPdfTemplates template = null;

        /*Template Background*/
        String imageBackground = null;

        /*Template Elements*/
        EasyPdfDocument document = null;
        EasyPdfPage page = null;
        EasyPdfContainer container = null;
        EasyPdfText text = null;
        EasyPdfImage image = null;
        EasyPdfTable table = null;
        EasyPdfBarcode barcode = null;
        EasyPdfQrCode qrCode = null;
    ...
    public static class SlimTemplateSettings {
        ...
        ColorsToEasyPdf[] boxBackColor = new ColorsToEasyPdf[]{null, null, null, null, null};
        ...
        ColorsToEasyPdf leftTitleColor = ColorsToEasyPdf.BLACK;
        ColorsToEasyPdf centerTitleColor = ColorsToEasyPdf.BLACK;
        ColorsToEasyPdf rightTitleColor = ColorsToEasyPdf.BLACK;
        FontSizeToEasyPdf leftTitleSize = FontSizeToEasyPdf.MEDIUM;
        FontSizeToEasyPdf centerTitleSize = FontSizeToEasyPdf.MEDIUM;
        FontSizeToEasyPdf rightTitleSize = FontSizeToEasyPdf.MEDIUM;
        FontNameToEasyPdf leftTitleFont = FontNameToEasyPdf.HELVETICA_B;
        FontNameToEasyPdf centerTitleFont = FontNameToEasyPdf.HELVETICA_B;
        FontNameToEasyPdf rightTitleFont = FontNameToEasyPdf.HELVETICA_B;
        ...
        ColorsToEasyPdf[] columnBoxLeftBackColor = new ColorsToEasyPdf[]{null, null, null, null, null};
        ColorsToEasyPdf[] columnBoxCenterBackColor = new ColorsToEasyPdf[]{null, null, null, null, null};
        ColorsToEasyPdf[] columnBoxRightBackColor = new ColorsToEasyPdf[]{null, null, null, null, null};
        ColorsToEasyPdf[] columnBoxLeftBorderColor = new ColorsToEasyPdf[]{null, null, null, null, null};
        ColorsToEasyPdf[] columnBoxCenterBorderColor = new ColorsToEasyPdf[]{null, null, null, null, null};
        ColorsToEasyPdf[] columnBoxRightBorderColor = new ColorsToEasyPdf[]{null, null, null, null, null};
        ColorsToEasyPdf[] columnBoxLeftTextColor = new ColorsToEasyPdf[]{null, null, null, null, null};
        ColorsToEasyPdf[] columnBoxCenterTextColor = new ColorsToEasyPdf[]{null, null, null, null, null};
        ColorsToEasyPdf[] columnBoxRightTextColor = new ColorsToEasyPdf[]{null, null, null, null, null};
        FontSizeToEasyPdf[] columnBoxLeftFontSize = new FontSizeToEasyPdf[]{null, null, null, null, null};
        FontSizeToEasyPdf[] columnBoxCenterFontSize = new FontSizeToEasyPdf[]{null, null, null, null, null};
        FontSizeToEasyPdf[] columnBoxRightFontSize = new FontSizeToEasyPdf[]{null, null, null, null, null};
        FontNameToEasyPdf[] columnBoxLeftFontName = new FontNameToEasyPdf[]{null, null, null, null, null};
        FontNameToEasyPdf[] columnBoxCenterFontName = new FontNameToEasyPdf[]{null, null, null, null, null};
        FontNameToEasyPdf[] columnBoxRightFontName = new FontNameToEasyPdf[]{null, null, null, null, null};
        ...
        ColorsToEasyPdf tableBorderColor = ColorsToEasyPdf.WHITE;
        ColorsToEasyPdf tableHeaderColor = ColorsToEasyPdf.GRAY;
        ColorsToEasyPdf tableBodyColor = ColorsToEasyPdf.ICE;
        ColorsToEasyPdf tableHeaderFontColor = ColorsToEasyPdf.WHITE;
        ColorsToEasyPdf tableBodyFontColor = ColorsToEasyPdf.GRAY;
        FontSizeToEasyPdf tableHeaderFontSize = FontSizeToEasyPdf.NORMAL;
        FontSizeToEasyPdf tableBodyFontSize = FontSizeToEasyPdf.NORMAL;
        FontNameToEasyPdf tableHeaderFontName = FontNameToEasyPdf.HELVETICA;
        FontNameToEasyPdf tableBodyFontName = FontNameToEasyPdf.HELVETICA;
        TableDimensionsToEasyPdf tableSize = TableDimensionsToEasyPdf.TABLE_5X6;
        ...
        FontSizeToEasyPdf signatureFontSize = FontSizeToEasyPdf.SMALL;
        FontNameToEasyPdf signatureFontName = FontNameToEasyPdf.HELVETICA_B;
        ColorsToEasyPdf signatureBoxColor = ColorsToEasyPdf.BLACK;
        ...
        FontSizeToEasyPdf signatureTapeFontSize = FontSizeToEasyPdf.SMALL;
        FontNameToEasyPdf signatureTapeFontName = FontNameToEasyPdf.HELVETICA_B;
        ColorsToEasyPdf signatureTapeColor = ColorsToEasyPdf.GRAY;
        ...
        ColorsToEasyPdf textColor = ColorsToEasyPdf.BLACK;
        FontSizeToEasyPdf textSize = FontSizeToEasyPdf.NORMAL;
        FontNameToEasyPdf textFont = FontNameToEasyPdf.HELVETICA;
