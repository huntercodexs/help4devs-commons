...
import static com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfResources.barcode128;
import static com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfResources.qrCode;
...
@Slf4j
@Service
public class Help4DevsEasyPdfBarcodeFormExtension extends Help4DevsEasyPdfCore {
    ...
    private void barcodeFormHeaderFrame(EasyPdfBarcodeForm bcFormSettings, PDPageContentStream contentStream) {
    ...
    private void barcodeFormHeaderValues(
        ...
        try {
            ...
            if (!bcFormSettings.isRevealFields()) {
                ...
                pageSettings.setFontSize(FontSizeToEasyPdf.MEDIUM);
            ...
            for (int j = 0; j < 2; j++) {
                ...
                if (j == 0) {
                    pageSettings.setFontSize(FontSizeToEasyPdf.PLUS);
                } else {
                    pageSettings.setFontSize(FontSizeToEasyPdf.NORMAL);
                }

                pageSettings.setFontName(FontNameToEasyPdf.HELVETICA_B);
    ...
    private void barcodeFormBodyFrame(EasyPdfBarcodeForm bcFormSettings, PDPageContentStream contentStream) {
    ...
    private void barcodeFormBodyLeftFields(
        ...
        try {
            ...
            pageSettings.setFontSize(FontSizeToEasyPdf.M_SMALL);
            pageSettings.setFontName(FontNameToEasyPdf.HELVETICA);
    ...
    private void barcodeFormBodyFooterFields(
        ...
        try {
            pageSettings.setFontSize(FontSizeToEasyPdf.SMALL);
    ...
    private void barcodeFormBodyFinalize(EasyPdfBarcodeForm bcFormSettings, PDPageContentStream contentStream) {
        ...
        try {
            ...
            if (bcFormSettings.getBorderStyle().equals(QrCodeBorderStyleToEasyPdf.BORDERLESS)) {
                contentStream.setLineWidth(3);
                contentStream.setStrokingColor(color(ColorsToEasyPdf.WHITE));
            ...
            if (bcFormSettings.getBorderStyle().equals(QrCodeBorderStyleToEasyPdf.LEFT_BORDERED)) {
                contentStream.setLineWidth(3);
                contentStream.setStrokingColor(color(ColorsToEasyPdf.WHITE));
                contentStream.addRect(
            ...
            if (bcFormSettings.getBorderStyle().equals(QrCodeBorderStyleToEasyPdf.BORDERED)) {
    ...
    private void barcodeFormBodyLeftValues(
        ...
        try {
            ...
            //Box 12
            if (bcFormSettings.isQrcode()) {
                EasyPdfQrCode qrCode = new EasyPdfQrCode();
                qrCode.setDpi(400);
                qrCode.setMargin(0);
                qrCode.setMatrix(0);
                qrCode.setSize(70);
                ...
                qrCode.setCodeType4Scanner(CodeType4ScannerToEasyPdf.QRCODE);
    ...
    public void barcodeFormBuild(
        ...
        if (bcFormSettings.isRevealFields()) {
            bcFormSettings = new EasyPdfBarcodeForm();
