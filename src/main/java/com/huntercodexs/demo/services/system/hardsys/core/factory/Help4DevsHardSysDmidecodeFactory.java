...
public class Help4DevsHardSysDmidecodeFactory extends Help4DevsHardSysBase {

    public Help4DevsHardSysDmidecodeFactory(HashMap<String, List<String>> resources) {
