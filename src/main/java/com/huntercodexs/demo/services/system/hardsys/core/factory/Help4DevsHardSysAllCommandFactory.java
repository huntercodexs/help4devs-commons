...
public class Help4DevsHardSysAllCommandFactory extends Help4DevsHardSysBase {

    public Help4DevsHardSysAllCommandFactory(HashMap<String, List<String>> resources) {
