...
public class Help4DevsSystemService {
    ...
    public static class GeneralSystemInfo {
        ...
        private String os; //Linux X Windows
        private HashMap<String, List<String>> metrics;

        public GeneralSystemInfo() {
            this.loader();
        }

        private void loader() {
            this.metrics = new HashMap<>();
            this.metrics.put("system", Arrays.asList("System Name", "System", "System", "System"));
            this.metrics.put("memory", Arrays.asList("Memory Used", "Memory", "Memory", "Memory"));
            this.metrics.put("processor", Arrays.asList("processor Name", "processor", "processor", "processor"));
            this.metrics.put("bios", Arrays.asList("Bios Type", "bios", "bios", "bios"));
            this.metrics.put("baseboard", Arrays.asList("Baseboard Name", "baseboard", "baseboard", "baseboard"));
            this.metrics.put("chassis", Arrays.asList("Chassis ID", "chassis", "chassis", "chassis"));
            this.metrics.put("cache", Arrays.asList("Cache Size", "cache", "cache", "cache"));
            this.metrics.put("connector", Arrays.asList("Connector Type", "connector", "connector", "connector"));
            this.metrics.put("slot", Arrays.asList("Slot Quantity", "slot", "slot", "slot"));
        ...
        public GeneralSystemInfoMetrics metrics() {
            return new GeneralSystemInfoMetrics(metrics);
        }
        ...
        public static class GeneralSystemInfoMetrics {
            ...
            public GeneralSystemInfoMetrics(HashMap<String, List<String>> metrics) {
                this.systemInfo = new SystemInfo(metrics.get("system"));
                this.memory = new Memory(metrics.get("memory"));
                this.processor = new Processor(metrics.get("processor"));
                this.bios = new Bios(metrics.get("bios"));
                this.baseboard = new Baseboard(metrics.get("baseboard"));
                this.chassis = new Chassis(metrics.get("chassis"));
                this.cache = new Cache(metrics.get("cache"));
                this.connector = new Connector(metrics.get("connector"));
                this.slot = new Slot(metrics.get("slot"));
            }
            ...
            public static class SystemInfo {
                ...
                public SystemInfo(List<String> system) {
                    this.systemName = system.get(0);
                }
            ...
            public static class Memory {
                ...
                public Memory(List<String> memory) {
                    this.memoryUsed = memory.get(0);
                }
                ...
                public String toString() {
                    return "Memory Used: "+this.getMemoryUsed();
                }
            }
            ...
            public static class Processor {
                ...
                public Processor(List<String> processor) {
                    this.processorName = processor.get(0);
                }
            ...
            public static class Bios {
                ...
                public Bios(List<String> bios) {
                    this.biosType = bios.get(0);
                }
                ...
                public String toString() {
                    return "Bios Type: "+this.getBiosType();
                }
            }
            ...
            public static class Baseboard {
                ...
                public Baseboard(List<String> baseboard) {
                    this.baseboardName = baseboard.get(0);
                }

                public String getBaseboardName() {
                    return this.baseboardName;
                }

                public String toString() {
                    return "Baseboard Name: "+this.getBaseboardName();
                }
            }
            ...
            public static class Chassis {
                ...
                public Chassis(List<String> chassis) {
                    this.chassisId = chassis.get(0);
                }
                ...
                public String toString() {
                    return "Chassis ID: "+this.getChassisId();
                }
            }
            ...
            public static class Cache {
                ...
                public Cache(List<String> cache) {
                    this.cacheSize = cache.get(0);
                }
                ...
                public String toString() {
                    return "Cache Size: "+this.getCacheSize();
                }
            }
            ...
            public static class Connector {
                ...
                public Connector(List<String> connector) {
                    this.connectorType = connector.get(0);
                }
                ...
                public String toString() {
                    return "Connector Type: "+this.getConnectorType();
                }
            }

            public static class Slot {

                public String slotQuantity;

                public Slot(List<String> slotQuantity) {
                    this.slotQuantity = slotQuantity.get(0);
                }
                ...
                public String toString() {
                    return "Slot Quantity: "+this.getSlotQuantity();
                }
            }
        }
    }
