...
import com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfTemplateSettings.BoxOpenDataContent;
import com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfTemplateSettings.BoxOpenTemplateSettings;
...
public class Help4DevsEasyPdfTemplateBoxOpenUnitaryTests extends Help4DevsBridgeTests {

    private final static String path = "./src/test/resources/help4devs/files/pdf";
    private final static String pdfFilenameLetter = path+"/my-easypdf-test-template-box-open-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = path+"/my-easypdf-test-template-box-open-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = path+"/my-easypdf-test-template-box-open-A4.pdf";
    private final static String pdfFilenameA4Layout = path+"/my-easypdf-test-template-box-open-A4-LAYOUT.pdf";
    private final static String imgJava = "./src/test/resources/help4devs/images/ads/java.png";
    private final static String imgBackground = "./src/test/resources/help4devs/images/background/easypdf-background-sample-3.jpg";
    ...
    private EasyPdfTemplateSettings easyPdfTemplateSettingsLetterLayout() {
        ...
        settings.setTemplate(EasyPdfTemplates.BOX_OPEN);
    ...
    public void templateTest() {
        String template = template(EasyPdfTemplates.BOX_OPEN);
        codexsTesterAssertExact("BOX_OPEN", template);
    }

    @Test
    public void easyPdfTemplateBoxOpenLetterLayoutTest() {
        ...
        templateManager.easyPdfTemplateBoxOpen(easyPdfTemplateSettingsLetterLayout());
    ...
    @Test
    public void easyPdfTemplateBoxOpenA4LayoutTest() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsEasyPdfTemplate templateManager = new Help4DevsEasyPdfTemplate();
        templateManager.easyPdfTemplateBoxOpen(easyPdfTemplateSettingsA4Layout());
    ...
    @Test
    public void easyPdfTemplateBoxOpenLetterSample1Test() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsEasyPdfTemplate templateManager = new Help4DevsEasyPdfTemplate();
        templateManager.easyPdfTemplateBoxOpen(easyPdfTemplateSettingsLetter());
    ...
    @Test
    public void easyPdfTemplateBoxOpenA4Sample1Test() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsEasyPdfTemplate templateManager = new Help4DevsEasyPdfTemplate();
        templateManager.easyPdfTemplateBoxOpen(easyPdfTemplateSettingsA4());
