...
import com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfTemplateSettings.BigBurgerDataContent;
import com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfTemplateSettings.BigBurgerTemplateSettings;
...
public class Help4DevsEasyPdfTemplateBigBurgerUnitaryTests extends Help4DevsBridgeTests {

    private final static String path = "./src/test/resources/help4devs/files/pdf";
    private final static String pdfFilenameLetter = path+"/my-easypdf-test-template-big-burger-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = path+"/my-easypdf-test-template-big-burger-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = path+"/my-easypdf-test-template-big-burger-A4.pdf";
    private final static String pdfFilenameA4Layout = path+"/my-easypdf-test-template-big-burger-A4-LAYOUT.pdf";
    private final static String imgJava = "./src/test/resources/help4devs/images/ads/java.png";
    private final static String imgBackground = "./src/test/resources/help4devs/images/background/easypdf-background-sample-6.jpg";
    ...
    private EasyPdfTemplateSettings easyPdfTemplateSettingsLetterLayout() {
        ...
        settings.setTemplate(EasyPdfTemplates.BIG_BURGER);
    ...
    public void templateTest() {
        String template = template(EasyPdfTemplates.BIG_BURGER);
