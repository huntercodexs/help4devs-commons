...
import com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfTemplateSettings.TripleFallDataContent;
import com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfTemplateSettings.TripleFallTemplateSettings;
...
public class Help4DevsEasyPdfTemplateTripleFallUnitaryTests extends Help4DevsBridgeTests {

    private final static String path = "./src/test/resources/help4devs/files/pdf";
    private final static String pdfFilenameLetter = path+"/my-easypdf-test-template-triple-fall-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = path+"/my-easypdf-test-template-triple-fall-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = path+"/my-easypdf-test-template-triple-fall-A4.pdf";
    private final static String pdfFilenameA4Layout = path+"/my-easypdf-test-template-triple-fall-A4-LAYOUT.pdf";
    ...
    private EasyPdfTemplateSettings easyPdfTemplateSettingsLetterLayout() {
        ...
        settings.setTemplate(EasyPdfTemplates.TRIPLE_FALL);
    ...
    public void templateTest() {
        String template = template(EasyPdfTemplates.TRIPLE_FALL);
