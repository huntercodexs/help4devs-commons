...
import com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfTemplateSettings.FreeDataContent;
import com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfTemplateSettings.FreeTemplateSettings;
...
public class Help4DevsEasyPdfTemplateFreeUnitaryTests extends Help4DevsBridgeTests {

    private final static String path = "./src/test/resources/help4devs/files/pdf";
    private final static String pdfFilenameLetter = path+"/my-easypdf-test-template-free-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = path+"/my-easypdf-test-template-free-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = path+"/my-easypdf-test-template-free-A4.pdf";
    private final static String pdfFilenameA4Layout = path+"/my-easypdf-test-template-free-A4-LAYOUT.pdf";
    private final static String imgJava = "./src/test/resources/help4devs/images/ads/java.png";
    private final static String imgBackground = "./src/test/resources/help4devs/images/background/easypdf-background-sample-7.jpg";
    ...
    private EasyPdfTemplateSettings easyPdfTemplateSettingsLetterLayout() {
        ...
        settings.setTemplate(EasyPdfTemplates.FREE);
    ...
    public void templateTest() {
        String template = template(EasyPdfTemplates.FREE);
