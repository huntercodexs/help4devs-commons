...
import com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfTemplateSettings.SlimBoxDataContent;
import com.huntercodexs.demo.services.pdf.easypdf.Help4DevsEasyPdfTemplateSettings.SlimBoxTemplateSettings;
...
public class Help4DevsEasyPdfTemplateSlimBoxUnitaryTests extends Help4DevsBridgeTests {

    private final static String path = "./src/test/resources/help4devs/files/pdf";
    private final static String pdfFilenameLetter = path+"/my-easypdf-test-template-slim-box-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = path+"/my-easypdf-test-template-slim-box-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = path+"/my-easypdf-test-template-slim-box-A4.pdf";
    private final static String pdfFilenameA4Layout = path+"/my-easypdf-test-template-slim-box-A4-LAYOUT.pdf";
    private final static String imgJava = "./src/test/resources/help4devs/images/ads/java.png";
    private final static String imgBackground = "./src/test/resources/help4devs/images/background/easypdf-background-sample-4.jpg";
    ...
    private EasyPdfTemplateSettings easyPdfTemplateSettingsLetterLayout() {
        ...
        settings.setTemplate(EasyPdfTemplates.SLIM_BOX);
    ...
    public void templateTest() {
        String template = template(EasyPdfTemplates.SLIM_BOX);
        codexsTesterAssertExact("SLIM_BOX", template);
    }

    @Test
    public void easyPdfTemplateSlimBoxLetterLayoutTest() {
        ...
        templateManager.easyPdfTemplateSlimBox(easyPdfTemplateSettingsLetterLayout());
    ...
    @Test
    public void easyPdfTemplateSlimBoxA4LayoutTest() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsEasyPdfTemplate templateManager = new Help4DevsEasyPdfTemplate();
        templateManager.easyPdfTemplateSlimBox(easyPdfTemplateSettingsA4Layout());
    ...
    @Test
    public void easyPdfTemplateSlimBoxLetterSample1Test() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsEasyPdfTemplate templateManager = new Help4DevsEasyPdfTemplate();
        templateManager.easyPdfTemplateSlimBox(easyPdfTemplateSettingsLetter());
    ...
    @Test
    public void easyPdfTemplateSlimBoxA4Sample1Test() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsEasyPdfTemplate templateManager = new Help4DevsEasyPdfTemplate();
        templateManager.easyPdfTemplateSlimBox(easyPdfTemplateSettingsA4());
