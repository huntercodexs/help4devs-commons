...
import static com.huntercodexs.demo.services.system.hardsys.command.Help4DevsHardSysCommands.LSHW;

public class Help4DevsHardSysLshwUnitaryTests extends Help4DevsBridgeTests {

    @Test
    public void generalSystemInfoByLshwCommandTest() {
        Help4DevsHardSys hardSys = new Help4DevsHardSys(LSHW);
        hardSys.json();
        ...
        //--CONTROLLER
        Help4DevsControllerDetails controller = hardSys.resources().getController();
        System.out.println(controller.getDetails());
    }

    @Test
    public void generalSystemInfoByLshwCommand_GROUP_Test() {
        Help4DevsHardSys hardSys = new Help4DevsHardSys(LSHW);
        hardSys.json();
    ...
    @Test
    public void generalSystemInfoByLshwCommand_ALL_JSON_Test() {
        Help4DevsHardSys hardSys = new Help4DevsHardSys(LSHW);
        hardSys.json();
    ...
    @Test
    public void generalSystemInfoByLshwCommand_ALL_DTO_Test() {
        Help4DevsHardSys hardSys = new Help4DevsHardSys(LSHW);
