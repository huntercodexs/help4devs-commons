...
public class Help4DevsPdfBoxTemplateFreeUnitaryTests extends Help4DevsBridgeTests {
    ...
    private final static String pdfFilenameLetter = path+"/my-pdfbox-test-template-free-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = path+"/my-pdfbox-test-template-free-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = path+"/my-pdfbox-test-template-free-A4.pdf";
    private final static String pdfFilenameA4Layout = path+"/my-pdfbox-test-template-free-A4-LAYOUT.pdf";
    ...
    @Test
    public void pdfBoxTemplateFreeLetterLayoutTest() {
        ...
        templateManager.pdfBoxTemplateFree(pdfBoxTemplateSettingsLetterLayout());
    ...
    @Test
    public void pdfBoxTemplateFreeA4LayoutTest() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsPdfBoxTemplate templateManager = new Help4DevsPdfBoxTemplate();
        templateManager.pdfBoxTemplateFree(pdfBoxTemplateSettingsA4Layout());
    ...
    @Test
    public void pdfBoxTemplateFreeLetterSample1Test() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsPdfBoxTemplate templateManager = new Help4DevsPdfBoxTemplate();
        templateManager.pdfBoxTemplateFree(pdfBoxTemplateSettingsLetter());
    ...
    @Test
    public void pdfBoxTemplateFreeA4Sample1Test() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsPdfBoxTemplate templateManager = new Help4DevsPdfBoxTemplate();
        templateManager.pdfBoxTemplateFree(pdfBoxTemplateSettingsA4());
