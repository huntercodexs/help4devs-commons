...
import com.huntercodexs.demo.services.pdfbox.Help4DevsPdfBoxTemplateSettings.FreeDataContent;
import com.huntercodexs.demo.services.pdfbox.Help4DevsPdfBoxTemplateSettings.FreeTemplateSettings;
...
public class Help4DevsPdfBoxTemplateFreeUnitaryTests extends Help4DevsBridgeTests {

    private final static String pdfFilenameLetter = "./src/test/resources/help4devs/files/pdf/my-pdfbox-test-template-free-LETTER.pdf";
    private final static String pdfFilenameLetterLayout = "./src/test/resources/help4devs/files/pdf/my-pdfbox-test-template-free-LETTER-LAYOUT.pdf";
    private final static String pdfFilenameA4 = "./src/test/resources/help4devs/files/pdf/my-pdfbox-test-template-free-A4.pdf";
    private final static String pdfFilenameA4Layout = "./src/test/resources/help4devs/files/pdf/my-pdfbox-test-template-free-A4-LAYOUT.pdf";
    private final static String imgJava = "./src/test/resources/help4devs/images/ads/java.png";
    private final static String imgBackground = "./src/test/resources/help4devs/images/background/pdfbox-background-sample-7.jpg";
    ...
    private FreeTemplateSettings freeSettings_LETTER_LAYOUT() {
    ...
    private FreeTemplateSettings freeSettings_LETTER() {
        FreeTemplateSettings settings = new FreeTemplateSettings();
    ...
    private FreeTemplateSettings freeSettings_A4_LAYOUT() {
        FreeTemplateSettings settings = new FreeTemplateSettings();
    ...
    private FreeTemplateSettings freeSettings_A4() {
        FreeTemplateSettings settings = new FreeTemplateSettings();
    ...
    private PdfBoxTemplateSettings pdfBoxTemplateSettings_LETTER_LAYOUT() {
        ...
        settings.setTemplate(PdfBoxTemplates.FREE);
        ...
        settings.setFree(freeSettings_LETTER_LAYOUT());
    ...
    private PdfBoxTemplateSettings pdfBoxTemplateSettings_LETTER() {
        ...
        settings.setBarcode(barcodeSettings());
        settings.setQrCode(qrCodeSettings());
        settings.setFree(freeSettings_LETTER());
        settings.setFreeContent(freeData());
        return settings;
    }
    ...
    private PdfBoxTemplateSettings pdfBoxTemplateSettings_A4_LAYOUT() {
        ...
        settings.setBarcode(barcodeSettings());
        settings.setQrCode(qrCodeSettings());
        settings.setFree(freeSettings_A4_LAYOUT());
        settings.setFreeContent(freeData());
        return settings;
    }
    ...
    private PdfBoxTemplateSettings pdfBoxTemplateSettings_A4() {
        ...
        settings.setBarcode(barcodeSettings());
        settings.setQrCode(qrCodeSettings());
        settings.setFree(freeSettings_A4());
        settings.setFreeContent(freeData());
        return settings;
    }
    ...
    @Test
    public void pdfBoxTemplateFree_LETTER_LAYOUT_Test() {
        ...
        templateManager.pdfBoxTemplateFree(pdfBoxTemplateSettings_LETTER_LAYOUT());
    ...
    @Test
    public void pdfBoxTemplateFree_LETTER_Test() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsPdfBoxTemplate templateManager = new Help4DevsPdfBoxTemplate();
        templateManager.pdfBoxTemplateFree(pdfBoxTemplateSettings_LETTER());
    ...
    @Test
    public void pdfBoxTemplateFree_A4_LAYOUT_Test() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsPdfBoxTemplate templateManager = new Help4DevsPdfBoxTemplate();
        templateManager.pdfBoxTemplateFree(pdfBoxTemplateSettings_A4_LAYOUT());
    ...
    @Test
    public void pdfBoxTemplateFree_A4_Test() {
        Runtime rt = Runtime.getRuntime();
        ...
        Help4DevsPdfBoxTemplate templateManager = new Help4DevsPdfBoxTemplate();
        templateManager.pdfBoxTemplateFree(pdfBoxTemplateSettings_A4());
